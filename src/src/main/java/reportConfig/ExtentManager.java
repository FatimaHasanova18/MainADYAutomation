...
public class ExtentManager {
    ...
    public static synchronized ExtentReports getExtentReports() {
        if (extent == null) {
            ...
            spark.config().setDocumentTitle("ADY Automation Test Result");
            spark.config().setReportName("ADY Regression Test Suite");
            ...
            extent.setSystemInfo("Tester", "Fatima Hasanova");
